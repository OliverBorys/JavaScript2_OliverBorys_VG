        ...
        <div className="flex justify-center mt-8 space-x-6">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M23.498 6.186a2.994 2.994 0 00-2.106-2.13C19.63 3.5 12 3.5 12 3.5s-7.63 0-9.392.556a2.994 2.994 0 00-2.106 2.13C0 8.049 0 12 0 12s0 3.951.502 5.814c.284 1.05 1.06 1.862 2.106 2.13C4.37 20.5 12 20.5 12 20.5s7.63 0 9.392-.556a2.994 2.994 0 002.106-2.13C24 15.951 24 12 24 12s0-3.951-.502-5.814zM9.75 15.5v-7l6.5 3.5-6.5 3.5z" />
            </svg>
          </a>
        </div>
