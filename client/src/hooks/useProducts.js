...
const useProducts = () => {
  ...
  return {
    state, // ✅ AdminPage will use this
    dispatch,
    deleteProduct,
    products: state.products || [], // ✅ ShopPage & SearchPage will use these
...
//   return {
//     products: state.products || [], // Ensure products is always an array
//     categories: state.categories || [], // Ensure categories is always an array
//     loading: state.loading,
//     error: state.error,
